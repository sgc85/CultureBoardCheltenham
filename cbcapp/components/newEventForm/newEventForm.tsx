...
const NewEventForm = () => {
  ...
  return (
    <Box>
      ...
      >
        ...
        <form id="event-form" onSubmit={handleSubmit}>
          <FormGroup>
            ...
            <FormControl sx={{ mb: 3 }}>
              <TextField type="text" name="description" label="Description" multiline rows={4} />
            </FormControl>
            ...
            <Slider value={ageRange} onChange={handleAgeRangeChange} valueLabelDisplay="auto" disableSwap min={0} max={25} marks={marks} />
      ...
      <Snackbar open={snackBarOpen} autoHideDuration={5000} onClose={() => setSnackBarOpen(false)} message={message} />
    </Box>
  );
};
